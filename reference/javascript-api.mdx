...
description: "Complete reference for script.js: the DOMContentLoaded wrapper, drag state variables, title bar mousedown, document mousemove, mouseup, and the close button click handler."
---
