---
title: "Window: a macOS-style floating window for the web"
sidebarTitle: "Introduction"
description: "Window is a zero-dependency HTML/CSS/JS component that renders a draggable, closable macOS-style window. No build step required."
---
